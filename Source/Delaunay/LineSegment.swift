...
open class LineSegment {
    ...
    public static func compareLengths_MAX(_ segment0: LineSegment, segment1: LineSegment) -> Int {
    ...
    public static func compareLengths(_ edge0:LineSegment, edge1:LineSegment) -> Int{
